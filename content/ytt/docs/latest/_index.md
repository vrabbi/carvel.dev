...
For more around templating...
- see templating in action through a progressive set of examples in [the `ytt` Playground](/ytt/#example:example-plain-yaml);
- learn more about Data Values in [ytt @data/values](ytt-data-values.md); 
